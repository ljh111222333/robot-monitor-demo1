    ...
    <el-collapse>
      <el-collapse-item title="robot controler" name="1" :disabled>
          ...
          <el-collapse-item title="scene控制" name="1">
            <el-row class="controler-item">
              ...
              <el-col class="item-value" :span="16">
                <el-color-picker
                  :model-value="sceneConfig.bgColor"
            ...
            <el-row class="controler-item">
              ...
              <el-col class="item-value" :span="16">
                <el-checkbox
                  v-model="sceneConfig.axesHelper"
                  size="large"
                  @change="openAxesHelper"
                />
              </el-col>
            </el-row>
          </el-collapse-item>
        ...
        <el-row justify="center" class="resetall-row">
          <el-button class="logposition-btn" @click="logPosition"
            >输出camera位置信息</el-button
          >

          <el-button class="resetall-btn" @click="resetAll"
            >恢复默认设置</el-button
          >
        </el-row>
      </el-collapse-item>
